...
class PictureminatorApp(ctk.CTk):
    def __init__(self):
        ...
        self.center_frame.place(relx=0.5, rely=0.5, anchor='center')  # Use place geometry manager for centering
    ...
    def update_switches(self, selected_option):
        ...
        # if selected_option == 'Year':
        #     self.year_sort_var.set(not year_onf)
        # elif selected_option == 'Month':
        #     self.month_sort_var.set(not month_onf)
        # elif selected_option == 'NoOrder':
        #     self.no_sort_var.set(not nosort_onf)
        #     self.month_sort_var.set(False)
        #     self.year_sort_var.set(False)
